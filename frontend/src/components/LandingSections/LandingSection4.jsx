...
const LandingSection4 = () => {
  return (
    <section className="w-full flex flex-col items-center text-white relative">
      <img
        className="absolute bottom-0 left-0 -z-10 w-full h-auto"
        src={landingSection4Img1}
        alt="landingSection4Img1"
      />
      <h2 className="font-semibold text-4xl leading-[45px] text-primary mt-[132px]">
        ¡Celebra logros con estilo!
      </h2>
      <div className="w-[526px] h-[96px] shadow-buttonshadow rounded-[10px] flex items-center justify-center px-[50px] mb-[300px]">
        <p className="text-center font-semibold text-xl leading-6 text-grey">
          Fácil, seguro y confiable. Ahorra tiempo y crea algo verdaderamente especial.
        </p>
      </div>
      <h3 className="font-extrabold text-[32px] leading-[39px] text-center mb-[50px]">
        Selecciona tu plan ideal
      </h3>
      <article className="mb-[41px] w-full flex justify-center gap-[38px]">
      ...
      <h4 className="font-bold text-2xl leading-[30px] text-center mb-5">
        ¿Ningún plan se ajusta a tus necesidades?
      </h4>
      <button className="shadow-buttonshadow w-[328px] h-[48px] bg-beige rounded-[10px] text-white font-bold text-[17px] leading-6 mb-[61px]">
        ¡Contactanos!
      </button>
    </section>
  );
