...
const Certificate_06 = ({
  ...
  return (
    <section
      ...
      <div className="max-w-[46.1875rem] relative text-[.9em] text-center text-black">
        <img
        ...
        <div className="flex flex-col justify-between absolute h-full w-full top-0 left-0 p-[5%] sm:p-[6.5%] md:p-[5%]">
          <div className=" flex flex-col w-full items-center mt-[.6em]   gap-[1em]   mb-1 md:mb-0 h-[25%] max-h-[90px] ">
            <div
              className={`${
                certificateTitle ? "bg-[#EC401A]" : ""
              } rounded font-bold  text-white mt-1`}>
          ...
          <div className=" sm:px-[3%] h-[40%]  flex justify-between flex-col mt-[1.5em]">
            <p>Certifica a</p>
            <p className=" text-[#BA079D] text-[1.8em] font-semibold mt-[.1em]  lg:mb-[.1em] lg:mt-[.6em]">
          ...
          <div className=" flex justify-between h-1/4 px-[2.5em]">
            {authorities && authorities[0] && (
              <div className=" flex flex-col max-w-[33%] md:max-w-[30%] justify-end">
                ...
                <span className="text-[.6em] text-[#EC401A]">{authorities[0].position}</span>
              </div>
            )}
            {authorities && authorities[1] && (
              <div className=" flex flex-col max-w-[33%] md:max-w-[30%] justify-end">
                ...
                <span className="text-[.6em] text-[#EC401A]">{authorities[1].position}</span>
              </div>
            )}
          </div>
        </div>
