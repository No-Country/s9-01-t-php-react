      ...
      <div className="max-w-[46.1875rem] relative text-[.9em] text-center ">
        ...
        <div className="flex flex-col justify-between absolute h-full w-full top-0 left-0 p-[7%] sm:p-[6.5%] md:p-[5%]">
          <div className=" flex justify-between w-full items-center mb-1 h-[15%] max-h-[70px]">
            <div className="flex w-1/4 h-full justify-start items-center">
              {imgLogo ? (
                <img
                  src={imgLogo}
                ...
                <span className=" font-bold text-[2em] whitespace-nowrap">{institution}</span>
              )}
            </div>
            <div
              className={`${
          ...
          <div className=" sm:px-[3%]">
            <p className=" text-[2.1em] font-semibold my-[.2em]">
          ...
          <div className=" flex justify-between h-1/4 px-[5em]">
