  ...
  return (
    <footer className="h-[196px] w-full">
      <div className="h-full w-full flex bg-primary px-[78px] text-white">
        ...
        <div className="w-1/2 h-full flex flex-col justify-start pt-[30px] items-end gap-6">
      ...
      <div className="w-full h-[44px] pl-[80px] flex justify-start items-center gap-5 bg-beige text-white">
